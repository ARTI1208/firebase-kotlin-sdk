...
public actual class FieldValue internal actual constructor(internal actual val nativeValue: Any) {
    ...
    public actual companion object {
        ...
        public actual fun arrayUnion(vararg elements: Any): FieldValue = rethrow { FieldValue(jsArrayUnion(*(elements as Array<JsAny>))) }
        public actual fun arrayRemove(vararg elements: Any): FieldValue = rethrow { FieldValue(jsArrayRemove(*(elements as Array<JsAny>))) }
    }
}
